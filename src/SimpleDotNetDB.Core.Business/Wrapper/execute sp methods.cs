...
namespace SimpleDotNetDB.Core.Business
{
    ...
    {
        public void ExecuteStoredProcedureNonQuery(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
                CommandSetup(spName, null, null, true);
        ...
        public string ExecuteStoredProcedureReturnString(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public string ExecuteStoredProcedureReturnJson(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public string[] ExecuteStoredProcedureReturnStringArray(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public List<dynamic> ExecuteStoredProcedureReturnDynamicList(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public DataTable ExecuteStoredProcedureReturnDataTable(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public DataSet ExecuteStoredProcedureReturnDataSet(string spName, bool enforceConstraints)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public List<T> ExecuteStoredProcedureReturn<T>(string spName)
        {
            try
            {
                //Sets up the command object with all the required processing
        ...
        public List<T> ExecuteStoredProcedureReturn<T>(string spName, object parameters)
        {
            try
            {
                //Sets up the command object with all the required processing
